...
namespace Win.App.Client
{
    public partial class Form1 : Form
    {
        ...
        {
            GetUserName();
            QuizHubProxy.On<QuizL1>("DisplayQuestion", (quiz) => this.Invoke((Action)(() => DisplayQuestion(quiz))));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            QuizHubProxy.Invoke("QuestionAnsweredQL2", quiz, UserName);
            QuizHubProxy.Invoke("QuestionAnsweredQL3", quiz, UserName);
            QuizHubProxy.Invoke("QuestionAnsweredQClincher", quiz, UserName);
        }
