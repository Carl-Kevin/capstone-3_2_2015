...
{
    public partial class GQuizClincher : Form
    {
        public GQuizClincher()
        {
            CheckForIllegalCrossThreadCalls = false;
            InitializeComponent();
        }

        private void GQuizClincher_Load(object sender, EventArgs e)
        {
            SetupQuiz();
        }
        ...
        {
            ClincherDataGrid.DataSource = QuestionManager.GetGQuizByDifficulty(4);
            ContestantScoreDataGrid.DataSource = ScoreManager.GetGContestantScores();
        }
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var selectedIndex = tabControl.SelectedIndex + 4;
            switch (selectedIndex)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    ClincherDataGrid.DataSource = QuestionManager.GetGQuizByDifficulty(selectedIndex);
                    break;
