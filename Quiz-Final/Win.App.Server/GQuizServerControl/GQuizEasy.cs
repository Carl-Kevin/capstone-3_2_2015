...
{
    public partial class GQuizEasy : Form
    {
        public GQuizEasy()
        {
        ...
        private void GQuizEasy_Load(object sender, EventArgs e)
        {
            SetupQuiz();
        }
        ...
        {
            EasyDataGrid.DataSource = QuestionManager.GetGQuizByDifficulty(1);
            ContestantScoreDataGrid.DataSource = ScoreManager.GetGContestantScores();
        }
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 1:
                    EasyDataGrid.DataSource = QuestionManager.GetGQuizByDifficulty(selectedIndex);
                    break;
                case 2:
